...
public interface IWaitStrategy {
	 ...
	 * @version 0.1
	 */
	class MessageComparator implements Comparator<MessageAgent> {
		@Override
		public int compare(MessageAgent msg1, MessageAgent msg2) {
			int compSeqNum = 0;
			...
			if (msg1.getMsgType().compareTo(MessageType.BINDING) == 0 
				...
				int compServ =0;
				String servMsg1 = ((BindingMessage)msg1).getService();
				String servMsg2 = ((BindingMessage)msg2).getService();
				...
				int compBinder =0;
				String bindMsg1 = ((SelectionMessage)msg1).getBinder();
				String bindMsg2 = ((SelectionMessage)msg2).getBinder();
